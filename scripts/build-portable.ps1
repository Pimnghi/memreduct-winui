...
function Assert-ZipContents {
    ...
    try {
        ...
        $requiredEntries = @(
            ...
            "$TopLevelDirectory/docs/images/dashboard_screenshot.png",
            "$TopLevelDirectory/docs/images/dashboard_screenshot_en.png",
...
try {
    foreach ($architecture in $architectures) {
        ...
        $documentationDirectory = Join-Path $packageDirectory "docs"
